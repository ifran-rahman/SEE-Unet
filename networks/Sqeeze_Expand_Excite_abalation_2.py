...
def SEE_Block(x, see_id, squeeze=16, expand=64):
    ...
    right = Conv2D(expand, (3, 3), activation='relu', padding='same', name=unique("expand3x3"))(x)
...
def SEE_Unet_abalation_2(inputs, num_classes=1, deconv_ksize=3, dropout=0.5, activation='sigmoid'):
    """
